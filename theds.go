...
type ThedsStackProps struct {
	awscdk.StackProps
}

func NewThedsStack(scope constructs.Construct, id string, props *ThedsStackProps) awscdk.Stack {
...
func main() {
	...
	NewThedsStack(app, "ThedsStack", &ThedsStackProps{
		awscdk.StackProps{
			Env: env(),
		},
	})
